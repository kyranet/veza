import { create, createFromID, read, readDate, readIncrement, writeDate, writeIncrement, writeReceptive, read32At } from '../src/lib/Util/Header';
...
test('Create Header From ID', () => {
	...
	expect(clonedReceptive).toBe(true);
